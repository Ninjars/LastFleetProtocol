...
private fun bodyFontFamily() = FontFamily(
    Font(LFRes.Font.sairacondensed_regular, weight = FontWeight.Normal),
    Font(LFRes.Font.sairacondensed_bold, weight = FontWeight.Bold),
    Font(LFRes.Font.sairacondensed_light, weight = FontWeight.Light),
    Font(LFRes.Font.sairacondensed_medium, weight = FontWeight.Medium),
    Font(LFRes.Font.sairacondensed_semibold, weight = FontWeight.SemiBold),
    Font(LFRes.Font.sairacondensed_black, weight = FontWeight.Black),
    Font(LFRes.Font.sairacondensed_thin, weight = FontWeight.Thin),
)

@Composable
private fun titleFontFamily() = FontFamily(
    Font(LFRes.Font.megrim_regular)
)
